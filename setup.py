...
setup(
    ...
    description = 'With Backup API you can backup images to Google Photo',  # Required
    ...
    url = 'https://github.com/michagrandel/BackupApi',  # Optional
    ...
    keywords = 'google photos backup server uberspace cloud',  # Optional
